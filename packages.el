...
(load-file (expand-file-name "packages/init-company.el" user-emacs-directory))
(load-file (expand-file-name "packages/init-dired.el" user-emacs-directory))
(load-file (expand-file-name "packages/init-counsel.el" user-emacs-directory))
(load-file (expand-file-name "packages/init-diminish.el" user-emacs-directory))
(load-file (expand-file-name "packages/init-projectile.el" user-emacs-directory))
